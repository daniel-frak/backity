...
import { PageDiscoveredFile } from '../model/models';
...
export class FileDiscoveryClient {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDiscoveredFiles(pageable: Pageable, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<PageDiscoveredFile>;
    public getDiscoveredFiles(pageable: Pageable, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<PageDiscoveredFile>>;
    public getDiscoveredFiles(pageable: Pageable, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<PageDiscoveredFile>>;
    public getDiscoveredFiles(pageable: Pageable, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (pageable === null || pageable === undefined) {
            throw new Error('Required parameter pageable was null or undefined when calling getDiscoveredFiles.');
        }
