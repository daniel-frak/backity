...
describe('InputComponent', () => {
    ...
    it('should call onTouched on blur event', () => {
        const onTouchedSpy = vi.spyOn(inputComponent, 'onTouched').mockReturnValue(undefined);
    ...
    it('should update value and call onChange when onInput is triggered', () => {
        const onChangeSpy = vi.spyOn(inputComponent, 'onChange').mockReturnValue(undefined);
