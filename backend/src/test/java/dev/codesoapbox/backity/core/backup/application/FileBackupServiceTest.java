...
// @TODO Refactor these tests to be more readable
...
class FileBackupServiceTest {
    ...
    class BackUpFile {
        ...
        class Throwing {
            ...
            @Test
            void shouldMarkFileCopyAsFailedAndRemoveFileAndRethrowWrappedGivenIOException() {
            ...
            @Test
            void shouldMarkTrackedGivenFileDownloadWasCanceled() {
            ...
            class WhenFileDeleteThrows {
                ...
                @Test
                void shouldWrapOriginalExceptionGivenFileDeleteThrows() {
                ...
                @Test
                void shouldMarkFileCopyAsFailedWithReasonGivenFileDeleteThrows() {
                    FakeUnixStorageSolution storageSolution = storageSolutionFailingOnFileDeletion();
                    FileBackupContext fileBackupContext = TestFileBackupContext.enqueuedLocalGogBuilder()
                            .storageSolution(storageSolution)
                            .build();
                ...
                @Test
                void shouldNotRemoveFilePathFromFileCopyGivenFileDeleteThrows() {
                    FakeUnixStorageSolution storageSolution = storageSolutionFailingOnFileDeletion();
                    FileBackupContext fileBackupContext = TestFileBackupContext.enqueuedLocalGogBuilder()
                            .storageSolution(storageSolution)
                            .build();
