...
class GetGamesControllerIT {
    ...
    // @TODO Fix this test
    // @TODO Test discovered, successful, failed?
    @Test
    void shouldGetGames() throws Exception {
        ...
        Page<GameWithFileCopies> gameWithFilesPage = TestPage.of(List.of(
                new GameWithFileCopies(
                        new Game(gameId, "Test Game"),
                        List.of(new GameFileWithCopies(TestGameFile.gog(), List.of(TestFileCopy.discovered()))
                        ))), pagination);
