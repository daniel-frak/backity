...
class FileSizeTest {
    ...
    class FromString {
        ...
        void shouldHandleValidInputs(String input, long expectedBytes) {
        ...
        void shouldConvertToBytes(String input, long expectedBytes) {
            FileSize fileSize = FileSize.fromString(input);
        ...
        void shouldHandleInvalidInputs(String input, String expectedMessage) {
    ...
    class ToString {
        ...
        @CsvSource({
                ...
                "1023,1023 B",
                "1024,1 KB",
                "1_048_575,1024 KB", // Rounding up
                "1_048_576,1 MB",
                "1_073_741_823,1024 MB", // Rounding up
                "1_073_741_824,1 GB",
                "1_099_511_627_775,1024 GB", // Rounding up
                "1_099_511_627_776,1 TB",
                "1_125_899_906_842_623,1024 TB", // Rounding up
                "1_125_899_906_842_624,1 PB",
                "1_152_921_504_606_846_975,1024 PB", // Rounding up
                "1_152_921_504_606_846_976,1024 PB", // Nothing above PB
                "1_500,1.5 KB",
                "1_572_864,1.5 MB",
        ...
        void shouldReturnCorrectValue(long input, String expected) {
