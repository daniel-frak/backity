...
@ControllerTest
class GetProcessedFileListControllerIT {
    ...
    void shouldGetProcessedFileList() throws Exception {
        ...
        when(useCase.getProcessedFileList(pagination))
        ...
        mockMvc.perform(get("/api/" + GameFileDetailsRestResource.RESOURCE_URL + "/processed?size=1"))
                .andDo(print())
