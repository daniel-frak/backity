...
class FileCopyReplicatorTest {
    ...
    void shouldReplicateFile() throws IOException {
        ...
        DownloadProgress downloadProgress = mockDownloadProgressCreation();
    ...
    private DownloadProgress mockDownloadProgressCreation() {
        DownloadProgress downloadProgress = mock(DownloadProgress.class);
        when(downloadProgressFactory.create())
