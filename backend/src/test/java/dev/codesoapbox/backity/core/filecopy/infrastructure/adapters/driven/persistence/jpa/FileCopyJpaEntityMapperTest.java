...
class FileCopyJpaEntityMapperTest {
    ...
    private FileCopyJpaEntity jpaDiscovered() {
        return jpa(FileBackupStatus.DISCOVERED, null, null);
    }

    private FileCopyJpaEntity jpa(FileBackupStatus discovered, String failedReason, String filePath) {
    ...
    void shouldMapDiscoveredJpaToDomain() {
        ...
        FileCopy result = MAPPER.toModel(model);
    ...
    private FileCopyJpaEntity jpaSuccessful() {
        return jpa(FileBackupStatus.SUCCESS, null, "someFilePath");
    }
    ...
    private FileCopyJpaEntity jpaFailed() {
        return jpa(FileBackupStatus.FAILED, "someFailedReason", null);
    }
