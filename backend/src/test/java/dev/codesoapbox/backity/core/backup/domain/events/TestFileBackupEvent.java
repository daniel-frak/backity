...
public final class TestFileBackupEvent {
    ...
    private static final SourceFileId SOURCE_FILE_ID = new SourceFileId("acde26d7-33c7-42ee-be16-bca91a604b48");
    ...
    private static final FileCopyNaturalId FILE_COPY_NATURAL_ID = new FileCopyNaturalId(SOURCE_FILE_ID, BACKUP_TARGET_ID);
