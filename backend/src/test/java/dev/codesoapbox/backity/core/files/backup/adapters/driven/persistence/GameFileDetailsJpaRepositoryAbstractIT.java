...
import static dev.codesoapbox.backity.core.files.domain.backup.model.TestGameFileDetails.*;
...
abstract class GameFileDetailsJpaRepositoryAbstractIT {
    ...
    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_1 = () -> enqueued()
    ...
    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_2 = () -> successful()
            .id(new GameFileDetailsId(UUID.fromString("a6adc122-df20-4e2c-a975-7d4af7104704")))
            .gameId(new GameId(UUID.fromString("1eec1c19-25bf-4094-b926-84b5bb8fa281")))
            .build();

    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_3 = () -> enqueued()
    ...
    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_4 = () -> failed()
            .id(new GameFileDetailsId(UUID.fromString("568afe65-018b-40fc-a8b4-481ded571ff8")))
            .gameId(new GameId(UUID.fromString("5bdd248a-c3aa-487a-8479-0bfdb32f7ae5")))
            .build();

    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_5 = () -> inProgress()
            .id(new GameFileDetailsId(UUID.fromString("0a2a4b8d-f02e-4e3e-a3da-f47e1ea6aa30")))
            .gameId(new GameId(UUID.fromString("1eec1c19-25bf-4094-b926-84b5bb8fa281")))
            .build();

    private static final Supplier<GameFileDetails> GAME_FILE_DETAILS_6 = () -> discovered()
    ...
    @Test
    void shouldSave() {
        GameFileDetails newGameFileDetails = full().build();
