...
abstract class GameFileDetailsJpaRepositoryAbstractIT {
    ...
    private void persistTestEnqueuedFiles() {
        entityManager.getTransaction().begin();
        entityManager.createNativeQuery("ALTER SEQUENCE seq_game_file_details RESTART WITH 1").executeUpdate();
        entityManager.createNativeQuery("""                         
                        ...
                        (NEXTVAL('seq_game_file_details'), 'someSource1', 'someUrl1', 'someTitle1', 
                        ...
                        INSERT INTO GAME_FILE_DETAILS
                        (id, source, url, title, original_file_name, game_title, game_id, version, size, date_created, backup_status, backup_failed_reason) VALUES
                        (NEXTVAL('seq_game_file_details'), 'someSource2', 'someUrl2', 'someTitle2', 
                        ...
                        INSERT INTO GAME_FILE_DETAILS
                        (id, source, url, title, original_file_name, game_title, game_id, version, size, date_created, backup_status, backup_failed_reason) VALUES
                        (NEXTVAL('seq_game_file_details'), 'someSource3', 'someUrl3', 'someTitle3', 
                        ...
                        INSERT INTO GAME_FILE_DETAILS
                        (id, source, url, title, original_file_name, game_title, game_id, version, size, date_created, backup_status, backup_failed_reason) VALUES
                        (NEXTVAL('seq_game_file_details'), 'someSource4', 'someUrl4', 'someTitle4', 
                        ...
                        INSERT INTO GAME_FILE_DETAILS
                        (id, source, url, title, original_file_name, game_title, game_id, version, size, date_created, backup_status, backup_failed_reason) VALUES
                        (NEXTVAL('seq_game_file_details'), 'someSource5', 'someUrl5', 'someTitle5', 
                        ...
                        INSERT INTO GAME_FILE_DETAILS
                        (id, source, url, title, original_file_name, game_title, game_id, version, size, date_created, backup_status, backup_failed_reason) VALUES
                        (NEXTVAL('seq_game_file_details'), 'someSource6', 'someUrl6', 'someTitle6', 
    ...
    @Test
    void shouldFindById() {
        Optional<GameFileDetails> result = gameFileVersionJpaRepository.findById(1L);
