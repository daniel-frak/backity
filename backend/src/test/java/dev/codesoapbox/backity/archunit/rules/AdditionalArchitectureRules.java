...
public class AdditionalArchitectureRules {
    ...
    static final ArchRule CONTROLLER_METHODS_SHOULD_NOT_RETURN_DOMAIN_CLASSES = methods()
            ...
            .should(new ArchCondition<>("not return domain classes") {
                ...
                private boolean isOriginOfDependency(JavaMethod method, Dependency dependency) {
                    return method.getAccessesFromSelf().stream()
                            .anyMatch(access -> access.getTargetOwner().equals(dependency.getTargetClass()));
                }
