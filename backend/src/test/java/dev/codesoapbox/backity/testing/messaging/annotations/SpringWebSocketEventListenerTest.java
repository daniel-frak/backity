...
import dev.codesoapbox.backity.testing.messaging.extensions.WebSocketEventListenerTestExtension;
...
@ExtendWith(WebSocketEventListenerTestExtension.class)
@SpringWebSocketEventListenerTestBeans
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Inherited
public @interface SpringWebSocketEventListenerTest {
}
