...
class DomainEventSpringPublisherTest {

    private DomainEventSpringPublisher domainEventPublisher;
    ...
    @BeforeEach
    void setUp() {
        domainEventPublisher = new DomainEventSpringPublisher(applicationEventPublisher);
    }
