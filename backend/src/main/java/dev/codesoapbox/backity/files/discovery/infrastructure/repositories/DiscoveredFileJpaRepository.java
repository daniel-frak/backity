package dev.codesoapbox.backity.files.discovery.infrastructure.repositories;

import dev.codesoapbox.backity.files.discovery.domain.model.DiscoveredFile;
import dev.codesoapbox.backity.files.discovery.domain.repositories.DiscoveredFileRepository;
