...
public class GogFileBackupService implements GameProviderFileBackupService {
    ...
    @Override
    public TrackableFileStream acquireTrackableFileStream(GameFile gameFile, DownloadProgress downloadProgress) {
        FileSource fileSource = gameFile.getFileSource();
        return gogEmbedWebClient.initializeProgressAndStreamFile(fileSource, downloadProgress);
    }
