...
public class FileBackupUseCaseBeanConfig {
    ...
    @Bean
    ProcessFileCopyQueueUseCase processFileCopyQueueUseCase(FileCopyReplicationProcess fileCopyReplicationProcess,
        ...
        return new ProcessFileCopyQueueUseCase(fileCopyReplicationProcess, fileCopyRepository, fileBackupContextFactory,
                fileBackupService);
    }
