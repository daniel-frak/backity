...
public class GetFileCopyListController {
    ...
    @Operation(summary = "List processed file copies",
            description = "Returns a paginated list of all processed file copies (downloaded or failed)")
    @GetMapping
    public PageHttpDto<FileCopyHttpDto> getProcessedFileCopies(
