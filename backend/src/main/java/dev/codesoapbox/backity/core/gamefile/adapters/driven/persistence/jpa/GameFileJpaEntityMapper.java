...
public abstract class GameFileJpaEntityMapper {
    ...
    protected abstract GameProviderFileJpaEntity toEntity(GameProviderFile model);
    ...
    protected abstract GameProviderFile toModel(GameProviderFileJpaEntity entity);
