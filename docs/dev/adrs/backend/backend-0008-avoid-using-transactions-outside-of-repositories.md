...
- If such transactions also include additional work (e.g., extra queries, file processing, or
...
- Potentially higher risk of bugs from new developers due to them treating use cases as atomic
